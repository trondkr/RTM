...
class CMIP6_light:
    ...
    def get_ozone_dataset(self, current_experiment_id: str) -> xr.Dataset:
        ...
        assert isinstance(toz_full, xr.Dataset), "[CMIP6_light] Unable to open TOZ file: {toz_name}"
                ...
                for hour_of_day in range(0, 23, 4):
                    ...
                    for scenario in scenarios:
                        ...
                        for data_list, vari in zip([par, sw_srf, ghi, uv_b, uv_a, uv, uv_srf, uvi,
                            ...
                            self.save_irradiance_to_netcdf(filename, data_list, vari, time_counter,
    ...
    def save_irradiance_to_netcdf(self, filename, da, vari, time_counter, time, lat, lon):
